...
Revision ID: 37b2efdcc9be
Revises: 
Create Date: 2026-07-06 02:50:46.187205
...
def upgrade() -> None:
    ...
    sa.Column('token_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['price_id'], ['prices.id'], name='fk_price_tokens_price_id', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['token_id'], ['tokens.id'], name='fk_price_tokens_token_id'),
